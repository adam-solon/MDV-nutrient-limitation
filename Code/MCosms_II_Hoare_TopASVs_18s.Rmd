...
subtitle: "  \n Top ASVs Hoare Basin - 18S SSU rRNA gene"
author: "Adam J. Solon"
date: "`r Sys.Date()`"
...
asvTable.EUK.fp <- paste0(input2.fp, "/ASVtable_18S_wTax_hoare.txt") 
...
########################################################
# save as an R file
saveRDS(asvTab.EUK.b.b.5.T, paste0(objects2.h.fp, "/asvTab.EUK.b.b.5.T.rds"))
#save as .txt file
write.table(asvTab.EUK.b.b.5.T, file = paste0(output2.h.fp , "/HoareBULK_18S_RelativeAbundance.csv"), 
            sep = ",", row.names = TRUE, col.names = NA)

# CTRL samples
########################################################
# save as an R file
saveRDS(asvTab.EUK.b.c.5.T, paste0(objects2.h.fp, "/asvTab.EUK.b.c.5.T.rds"))
#save as .txt file
write.table(asvTab.EUK.b.c.5.T, file = paste0(output2.h.fp , "/HoareCTRL_18S_RelativeAbundance.csv"), 
            sep = ",", row.names = TRUE, col.names = NA)

# N samples
########################################################
# save as an R file
saveRDS(asvTab.EUK.b.n.5.T, paste0(objects2.h.fp, "/asvTab.EUK.b.n.5.T.rds"))
#save as .txt file
write.table(asvTab.EUK.b.n.5.T, file = paste0(output2.h.fp , "/HoareN_18S_RelativeAbundance.csv"), 
            sep = ",", row.names = TRUE, col.names = NA)

# P samples
########################################################
# save as an R file
saveRDS(asvTab.EUK.b.p.5.T, paste0(objects2.h.fp, "/asvTab.EUK.b.p.5.T.rds"))
#save as .txt file
write.table(asvTab.EUK.b.p.5.T, file = paste0(output2.h.fp , "/HoareP_18S_RelativeAbundance.csv"), 
            sep = ",", row.names = TRUE, col.names = NA)

# NP samples
########################################################
# save as an R file
saveRDS(asvTab.EUK.b.np.5.T, paste0(objects2.h.fp, "/asvTab.EUK.b.np.6.T.rds"))
#save as .txt file
write.table(asvTab.EUK.b.np.5.T, file = paste0(output2.h.fp , "/HoareNP_18S_RelativeAbundance.csv"), 
            sep = ",", row.names = TRUE, col.names = NA)
...
knitr::kable(asvTab.EUK.b.b.top, booktabs = T, digits = 2, caption = 'Most Relatively Abundant ASVs in Hoare basin bulk samples') %>%
...
#create table of library  
knitr::kable(asvTab.EUK.b.c.top, booktabs = T, digits = 2, caption = 'Most Relatively Abundant ASVs in Hoare basin control samples') %>%
  kable_styling(latex_options = c("striped", "scale_down", "hold_position"), font_size = 12) %>%
  row_spec(0, bold = T)
...
#create table of library  
knitr::kable(asvTab.EUK.b.n.top, booktabs = T, digits = 2, caption = 'Most Relatively Abundant ASVs in Hoare basin N samples') %>%
  kable_styling(latex_options = c("striped", "scale_down", "hold_position"), font_size = 12) %>%
  row_spec(0, bold = T)
...
#create table of library  
knitr::kable(asvTab.EUK.b.p.top, booktabs = T, digits = 2, caption = 'Most Relatively Abundant ASVs in Hoare basin P samples') %>%
  kable_styling(latex_options = c("striped", "scale_down", "hold_position"), font_size = 12) %>%
  row_spec(0, bold = T)
...
#create table of library  
knitr::kable(asvTab.EUK.b.np.top, booktabs = T, digits = 2, caption = 'Most Relatively Abundant ASVs in Hoare basin NP samples') %>%
  kable_styling(latex_options = c("striped", "scale_down", "hold_position"), font_size = 12) %>%
  row_spec(0, bold = T)
...
########################################################
# save as an R file
saveRDS(asvTab.EUK.b.b.top, paste0(objects2.h.fp, "/asvTab.EUK.b.b.top.rds"))
#save as .txt file
write.table(asvTab.EUK.b.b.top, file = paste0(output2.h.fp , "/HoareBULK_18S_Top.csv"), 
            sep = ",", row.names = TRUE, col.names = NA)

# CTRL samples
########################################################
# save as an R file
saveRDS(asvTab.EUK.b.c.top, paste0(objects2.h.fp, "/asvTab.EUK.b.c.top.rds"))
#save as .txt file
write.table(asvTab.EUK.b.c.top, file = paste0(output2.h.fp , "/HoareCTRL_18S_Top.csv"), 
            sep = ",", row.names = TRUE, col.names = NA)

# N samples
########################################################
# save as an R file
saveRDS(asvTab.EUK.b.n.top, paste0(objects2.h.fp, "/asvTab.EUK.b.n.top.rds"))
#save as .txt file
write.table(asvTab.EUK.b.n.top, file = paste0(output2.h.fp , "/HoareN_18S_Top.csv"), 
            sep = ",", row.names = TRUE, col.names = NA)

# P samples
########################################################
# save as an R file
saveRDS(asvTab.EUK.b.p.top, paste0(objects2.h.fp, "/asvTab.EUK.b.p.top.rds"))
#save as .txt file
write.table(asvTab.EUK.b.p.top, file = paste0(output2.h.fp , "/HoareP_18S_Top.csv"), 
            sep = ",", row.names = TRUE, col.names = NA)

# NP samples
########################################################
# save as an R file
saveRDS(asvTab.EUK.b.np.top, paste0(objects2.h.fp, "/asvTab.EUK.b.np.top.rds"))
#save as .txt file
write.table(asvTab.EUK.b.np.top, file = paste0(output2.h.fp , "/HoareNP_18S_Top.csv"), 
            sep = ",", row.names = TRUE, col.names = NA)
