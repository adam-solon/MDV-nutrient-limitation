...
subtitle: "  \n Top ASVs Fryxell Basin - 18S SSU rRNA gene"
author: "Adam J. Solon"
date: "`r Sys.Date()`"
...
# Script Summary  
This script processes the Amplicon Sequence Variants (ASVs) table from a nutrient limitation study of soils of Fryxell basin from Taylor Valley, antarctica.  It will determine mean relative abundances of ASVs in each experimental group (i.e., bulk, control, nitrogen, phosphorus, and nitrogen&phosphorus).
...
# Create further sub-directories for Fryxell basin
###################################################
...
asvTable.EUK.fp <- paste0(input2.fp, "/ASVtable_18S_wTax_fryxell.txt") 

# Mapping File (metadata relevant for study samples)
mappingFile.fp <- paste0(input2.fp, "/map_file_fryxell.txt") 
...
########################################################
# move rownames of ASV table into 1st column as 'ASV_ID'
asvTab.EUK.b.np.5 <- tibble::rownames_to_column(asvTab.EUK.b.np.5, "ASV_ID")
# Left Join using inner_join function from dplyr
asvTab.EUK.b.np.5.T <- asvTab.EUK.b.np.5 %>% inner_join(taxTab, by= "ASV_ID")
...
########################################################
# save as an R file
saveRDS(asvTab.EUK.b.b.5.T, paste0(objects2.f.fp, "/asvTab.EUK.b.b.5.T.rds"))
#save as .txt file
write.table(asvTab.EUK.b.b.5.T, file = paste0(output2.f.fp , "/FryxellBULK_18S_RelativeAbundance.csv"), 
            sep = ",", row.names = TRUE, col.names = NA)

# CTRL samples
########################################################
# save as an R file
saveRDS(asvTab.EUK.b.c.5.T, paste0(objects2.f.fp, "/asvTab.EUK.b.c.5.T.rds"))
#save as .txt file
write.table(asvTab.EUK.b.c.5.T, file = paste0(output2.f.fp , "/FryxellCTRL_18S_RelativeAbundance.csv"), 
            sep = ",", row.names = TRUE, col.names = NA)

# N samples
########################################################
# save as an R file
saveRDS(asvTab.EUK.b.n.5.T, paste0(objects2.f.fp, "/asvTab.EUK.b.n.5.T.rds"))
#save as .txt file
write.table(asvTab.EUK.b.n.5.T, file = paste0(output2.f.fp , "/FryxellN_18S_RelativeAbundance.csv"), 
            sep = ",", row.names = TRUE, col.names = NA)

# P samples
########################################################
# save as an R file
saveRDS(asvTab.EUK.b.p.5.T, paste0(objects2.f.fp, "/asvTab.EUK.b.p.5.T.rds"))
#save as .txt file
write.table(asvTab.EUK.b.p.5.T, file = paste0(output2.f.fp , "/FryxellP_18S_RelativeAbundance.csv"), 
            sep = ",", row.names = TRUE, col.names = NA)

# NP samples
########################################################
# save as an R file
saveRDS(asvTab.EUK.b.np.5.T, paste0(objects2.f.fp, "/asvTab.EUK.b.np.6.T.rds"))
#save as .txt file
write.table(asvTab.EUK.b.np.5.T, file = paste0(output2.f.fp , "/FryxellNP_18S_RelativeAbundance.csv"), 
            sep = ",", row.names = TRUE, col.names = NA)
...
#NP
asvTab.EUK.b.np.top <- asvTab.EUK.b.np.5.T %>% filter(total > 1.0)
...
knitr::kable(asvTab.EUK.b.b.top, booktabs = T, digits = 2, caption = 'Most Relatively Abundant ASVs in Fryxell basin bulk samples') %>%
...
#create table of library  
knitr::kable(asvTab.EUK.b.c.top, booktabs = T, digits = 2, caption = 'Most Relatively Abundant ASVs in Fryxell basin control samples') %>%
  kable_styling(latex_options = c("striped", "scale_down", "hold_position"), font_size = 12) %>%
  row_spec(0, bold = T)
...
#create table of library  
knitr::kable(asvTab.EUK.b.n.top, booktabs = T, digits = 2, caption = 'Most Relatively Abundant ASVs in Fryxell basin N samples') %>%
  kable_styling(latex_options = c("striped", "scale_down", "hold_position"), font_size = 12) %>%
  row_spec(0, bold = T)
...
#create table of library  
knitr::kable(asvTab.EUK.b.p.top, booktabs = T, digits = 2, caption = 'Most Relatively Abundant ASVs in Fryxell basin P samples') %>%
  kable_styling(latex_options = c("striped", "scale_down", "hold_position"), font_size = 12) %>%
  row_spec(0, bold = T)
...
#create table of library  
knitr::kable(asvTab.EUK.b.np.top, booktabs = T, digits = 2, caption = 'Most Relatively Abundant ASVs in Fryxell basin NP samples') %>%
  kable_styling(latex_options = c("striped", "scale_down", "hold_position"), font_size = 12) %>%
  row_spec(0, bold = T)
...
########################################################
# save as an R file
saveRDS(asvTab.EUK.b.b.top, paste0(objects2.f.fp, "/asvTab.EUK.b.b.top.rds"))
#save as .txt file
write.table(asvTab.EUK.b.b.top, file = paste0(output2.f.fp , "/FryxellBULK_18S_Top.csv"), 
            sep = ",", row.names = TRUE, col.names = NA)

# CTRL samples
########################################################
# save as an R file
saveRDS(asvTab.EUK.b.c.top, paste0(objects2.f.fp, "/asvTab.EUK.b.c.top.rds"))
#save as .txt file
write.table(asvTab.EUK.b.c.top, file = paste0(output2.f.fp , "/FryxellCTRL_18S_Top.csv"), 
            sep = ",", row.names = TRUE, col.names = NA)

# N samples
########################################################
# save as an R file
saveRDS(asvTab.EUK.b.n.top, paste0(objects2.f.fp, "/asvTab.EUK.b.n.top.rds"))
#save as .txt file
write.table(asvTab.EUK.b.n.top, file = paste0(output2.f.fp , "/FryxellN_18S_Top.csv"), 
            sep = ",", row.names = TRUE, col.names = NA)

# P samples
########################################################
# save as an R file
saveRDS(asvTab.EUK.b.p.top, paste0(objects2.f.fp, "/asvTab.EUK.b.p.top.rds"))
#save as .txt file
write.table(asvTab.EUK.b.p.top, file = paste0(output2.f.fp , "/FryxellP_18S_Top.csv"), 
            sep = ",", row.names = TRUE, col.names = NA)

# NP samples
########################################################
# save as an R file
saveRDS(asvTab.EUK.b.np.top, paste0(objects2.f.fp, "/asvTab.EUK.b.np.top.rds"))
#save as .txt file
write.table(asvTab.EUK.b.np.top, file = paste0(output2.f.fp , "/FryxellNP_18S_Top.csv"), 
            sep = ",", row.names = TRUE, col.names = NA)
