...
subtitle: "  \n Top ASVs Fryxell Basin - 16S SSU rRNA gene"
author: "Adam J. Solon"
date: "`r Sys.Date()`"
...
asvTable.BAC.fp <- paste0(input2.fp, "/ASVtable_16S_wTax_fryxell.txt") 
...
########################################################
# save as an R file
saveRDS(asvTab.BAC.b.b.5.T, paste0(objects2.f.fp, "/asvTab.BAC.b.b.5.T.rds"))
#save as .txt file
write.table(asvTab.BAC.b.b.5.T, file = paste0(output2.f.fp , "/FryxellBULK_16S_RelativeAbundance.csv"), 
            sep = ",", row.names = TRUE, col.names = NA)

# CTRL samples
########################################################
# save as an R file
saveRDS(asvTab.BAC.b.c.5.T, paste0(objects2.f.fp, "/asvTab.BAC.b.c.5.T.rds"))
#save as .txt file
write.table(asvTab.BAC.b.c.5.T, file = paste0(output2.f.fp , "/FryxellCTRL_16S_RelativeAbundance.csv"), 
            sep = ",", row.names = TRUE, col.names = NA)

# N samples
########################################################
# save as an R file
saveRDS(asvTab.BAC.b.n.5.T, paste0(objects2.f.fp, "/asvTab.BAC.b.n.5.T.rds"))
#save as .txt file
write.table(asvTab.BAC.b.n.5.T, file = paste0(output2.f.fp , "/FryxellN_16S_RelativeAbundance.csv"), 
            sep = ",", row.names = TRUE, col.names = NA)

# P samples
########################################################
# save as an R file
saveRDS(asvTab.BAC.b.p.5.T, paste0(objects2.f.fp, "/asvTab.BAC.b.p.5.T.rds"))
#save as .txt file
write.table(asvTab.BAC.b.p.5.T, file = paste0(output2.f.fp , "/FryxellP_16S_RelativeAbundance.csv"), 
            sep = ",", row.names = TRUE, col.names = NA)

# NP samples
########################################################
# save as an R file
saveRDS(asvTab.BAC.b.np.5.T, paste0(objects2.f.fp, "/asvTab.BAC.b.np.6.T.rds"))
#save as .txt file
write.table(asvTab.BAC.b.np.5.T, file = paste0(output2.f.fp , "/FryxellNP_16S_RelativeAbundance.csv"), 
            sep = ",", row.names = TRUE, col.names = NA)
...
knitr::kable(asvTab.BAC.b.b.top, booktabs = T, digits = 2, caption = 'Most Relatively Abundant ASVs in Fryxell basin bulk samples') %>%
...
#create table of library  
knitr::kable(asvTab.BAC.b.c.top, booktabs = T, digits = 2, caption = 'Most Relatively Abundant ASVs in Fryxell basin control samples') %>%
  kable_styling(latex_options = c("striped", "scale_down", "hold_position"), font_size = 12) %>%
  row_spec(0, bold = T)
...
#create table of library  
knitr::kable(asvTab.BAC.b.n.top, booktabs = T, digits = 2, caption = 'Most Relatively Abundant ASVs in Fryxell basin N samples') %>%
  kable_styling(latex_options = c("striped", "scale_down", "hold_position"), font_size = 12) %>%
  row_spec(0, bold = T)
...
#create table of library  
knitr::kable(asvTab.BAC.b.p.top, booktabs = T, digits = 2, caption = 'Most Relatively Abundant ASVs in Fryxell basin P samples') %>%
  kable_styling(latex_options = c("striped", "scale_down", "hold_position"), font_size = 12) %>%
  row_spec(0, bold = T)
...
#create table of library  
knitr::kable(asvTab.BAC.b.np.top, booktabs = T, digits = 2, caption = 'Most Relatively Abundant ASVs in Fryxell basin NP samples') %>%
  kable_styling(latex_options = c("striped", "scale_down", "hold_position"), font_size = 12) %>%
  row_spec(0, bold = T)
...
########################################################
# save as an R file
saveRDS(asvTab.BAC.b.b.top, paste0(objects2.f.fp, "/asvTab.BAC.b.b.top.rds"))
#save as .txt file
write.table(asvTab.BAC.b.b.top, file = paste0(output2.f.fp , "/FryxellBULK_16S_Top.csv"), 
            sep = ",", row.names = TRUE, col.names = NA)

# CTRL samples
########################################################
# save as an R file
saveRDS(asvTab.BAC.b.c.top, paste0(objects2.f.fp, "/asvTab.BAC.b.c.top.rds"))
#save as .txt file
write.table(asvTab.BAC.b.c.top, file = paste0(output2.f.fp , "/FryxellCTRL_16S_Top.csv"), 
            sep = ",", row.names = TRUE, col.names = NA)

# N samples
########################################################
# save as an R file
saveRDS(asvTab.BAC.b.n.top, paste0(objects2.f.fp, "/asvTab.BAC.b.n.top.rds"))
#save as .txt file
write.table(asvTab.BAC.b.n.top, file = paste0(output2.f.fp , "/FryxellN_16S_Top.csv"), 
            sep = ",", row.names = TRUE, col.names = NA)

# P samples
########################################################
# save as an R file
saveRDS(asvTab.BAC.b.p.top, paste0(objects2.f.fp, "/asvTab.BAC.b.p.top.rds"))
#save as .txt file
write.table(asvTab.BAC.b.p.top, file = paste0(output2.f.fp , "/FryxellP_16S_Top.csv"), 
            sep = ",", row.names = TRUE, col.names = NA)

# NP samples
########################################################
# save as an R file
saveRDS(asvTab.BAC.b.np.top, paste0(objects2.f.fp, "/asvTab.BAC.b.np.top.rds"))
#save as .txt file
write.table(asvTab.BAC.b.np.top, file = paste0(output2.f.fp , "/FryxellNP_16S_Top.csv"), 
            sep = ",", row.names = TRUE, col.names = NA)
