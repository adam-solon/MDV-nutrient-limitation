...
colnames(t.1)[1:8] <- c("Domain", "SuperGroup", "CladeH", "CladeM", "CladeL", "CladeLL", "GenusSpecies", "AccessionNumber")
...
knitr::kable(a.blanks.T, booktabs = T, digits = 2, caption = 'ESVs that are present in blank extractions - possible contaminanation') %>%
...
```{r}
#retain ESV_3 and ESV 104 ('planophila') as they are present across in bonney bulk soils (i.e. reverse contamination of blank is likely circumstance)
a.blanks.T.1 <- a.blanks.T %>% filter(ASV_ID != "ESV_3" & ASV_ID != "ESV_104")
...
a.13 <- subset (a.12, select = -c(Domain:AccessionNumber))
