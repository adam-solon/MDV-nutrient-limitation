---
title: "MDV Nutrient Limitation ASV table w/ taxonomy processing - 16S SSU rRNA gene"
author: "Adam Solon"
date: "`r Sys.Date()`"
...
# save as an R file
saveRDS(a.12, paste0(objects3.fp, "/ASV.table.12.wTax.filtered.rds"))

#save as .txt file
write.table(a.12, file = paste0(input3.fp, "/asvTab_16S_wTax_filtered.txt"), 
            sep = "\t", row.names = FALSE, col.names = TRUE)
...
# save mapping file subset as an R file
saveRDS(m.1, paste0(objects3.fp, "/m.1.rds"))

#save mapping file subset as .txt file 
write.table(m.1, file = paste0(input3.fp, "/map_file_no_blanks.txt"), 
            sep = "\t", row.names = FALSE, col.names = TRUE)
...
#for BD
#save hoare subset as an R file
saveRDS(a.hr.T, paste0(objects3.h.fp, "/asv.wTax.hr.rds"))

#save hoare subset as .txt file 
write.table(a.hr.T, file = paste0(input3.fp, "/ASVtable_16S_wTax_hoare.txt"), 
            sep = "\t", row.names = FALSE, col.names = TRUE)
