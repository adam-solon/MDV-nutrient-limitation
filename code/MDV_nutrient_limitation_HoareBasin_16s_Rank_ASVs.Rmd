...
asvTable.BAC.fp <- paste0(input.fp, "/ASVtable_16S_wTax_hoare.txt") 
...
asvTab.BAC.b.b.F <- asvTab.BAC.b.b.1 %>% select(-c(HR_Bulk_X, HR_Bulk_Y, HR_Bulk_Z))
...
########################################################
# save as an R file
saveRDS(asvTab.BAC.b.b.F.T, paste0(hoare1.fp, "/asvTab.BAC.b.b.F.T.rds"))
#save as .txt file
write.table(asvTab.BAC.b.b.F.T, file = paste0(hoare2.fp, "/HoareBulk_RelativeAbundance.txt"), 
            sep = "\t", row.names = TRUE, col.names = NA)

# CTRL samples
########################################################
# save as an R file
saveRDS(asvTab.BAC.b.c.5.T, paste0(hoare1.fp, "/asvTab.BAC.b.c.5.T.rds"))
#save as .txt file
write.table(asvTab.BAC.b.c.5.T, file = paste0(hoare2.fp, "/HoareCTRL_RelativeAbundance.txt"), 
            sep = "\t", row.names = TRUE, col.names = NA)

# N samples
########################################################
# save as an R file
saveRDS(asvTab.BAC.b.n.5.T, paste0(hoare1.fp, "/asvTab.BAC.b.n.5.T.rds"))
#save as .txt file
write.table(asvTab.BAC.b.n.5.T, file = paste0(hoare2.fp, "/HoareN_RelativeAbundance.txt"), 
            sep = "\t", row.names = TRUE, col.names = NA)

# P samples
########################################################
# save as an R file
saveRDS(asvTab.BAC.b.p.5.T, paste0(hoare1.fp, "/asvTab.BAC.b.p.5.T.rds"))
#save as .txt file
write.table(asvTab.BAC.b.p.5.T, file = paste0(hoare2.fp, "/HoareP_RelativeAbundance.txt"), 
            sep = "\t", row.names = TRUE, col.names = NA)

# NP samples
########################################################
# save as an R file
saveRDS(asvTab.BAC.b.np.F.T, paste0(hoare1.fp, "/asvTab.BAC.b.np.F.T.rds"))
#save as .txt file
write.table(asvTab.BAC.b.np.F.T, file = paste0(hoare2.fp, "/HoareNP_RelativeAbundance.txt"), 
            sep = "\t", row.names = TRUE, col.names = NA)
```